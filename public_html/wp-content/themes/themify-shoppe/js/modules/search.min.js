...
complete:function(){d.removeClass("themify-loading")},success:function(a){if(!e)c.html("");else if(a){var b=c.find(".search-option-tab li.active").index();c.hide().html(a);f(b);c.find(".search-option-tab li.active");k[e]=a}}}):c.html("")},100):c.html("")}})};f.on("themify_theme_search_init",function(b){l(b)})})(jQuery,Themify);
