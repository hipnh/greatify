...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'accent_font_color' => array(
			...
			'selector' => 'a, input[type=reset]:hover, input[type=submit]:hover, button:hover, #headerwrap a:hover, .sidemenu .search-button:hover, .post-title a:hover, #footerwrap a:hover, .fancy-heading, .fancy-heading .sub-head, .inline-fancy-heading .fancy-heading .sub-head, .related.products .fancy-heading, #main-nav ul .current_page_item > a, #main-nav ul .current-menu-item > a, #main-nav ul  a:hover, #main-nav .current_page_item ul a:hover, #main-nav ul .current_page_item a:hover, #main-nav .current-menu-item ul a:hover, #main-nav ul .current-menu-item a:hover, .woocommerce .woocommerce-product-rating, .social-share .share:hover:after',
			'prop' => 'color',
		),
		...
		'accent_background_font_color' => array(
			...
			'selector' => 'input[type=reset], input[type=submit], button, .icon-menu .icon-menu-count, #headerwrap #cart-icon, #main-nav .has-mega-column .product-categories li:hover > .count, #pagewrap .wpf_slider.ui-slider .ui-widget-header, #footerwrap .back-top a, #site-description, .woocommerce ul.products li.product .button, .woocommerce #content input.button, .woocommerce #respond input#submit, .woocommerce #content input.button.alt, .woocommerce #respond input#submit.alt, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button, .woocommerce a.button.alt, .woocommerce button.button.alt, .woocommerce input.button.alt, .woocommerce span.onsale,.woocommerce ul.products li.product .onsale, .wishlist-button.wishlisted, .woocommerce ul.products li.product a.wishlisted, #cart-wrap .button',
			'prop' => 'color',
		),
