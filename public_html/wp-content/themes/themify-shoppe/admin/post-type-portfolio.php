			...
			if( $posts ) {
				...
				$out = '<div data-lazy="1" class="loops-wrapper shortcode ' . implode(' ',$class) . ' tf_clear">';
					...
					if ( 'slider' === $themify->post_layout ) {
						...
						$out .= '<div class="slideshow tf_carousel tf_swiper-container tf_overflow tf_rel" data-lazy="1" data-autoplay="' . $autoplay . '" data-speed="' . $speed . '" data-scroll="' . $scroll . '" data-visible="' . $visible . '"><div class="tf_swiper-wrapper tf_lazy tf_rel tf_w tf_h">';
