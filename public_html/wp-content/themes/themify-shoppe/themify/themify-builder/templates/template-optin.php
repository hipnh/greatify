...
if ( 'on' === $fields_args['captcha']){
    $captcha_site_key = themify_get( 'setting-recaptcha_site_key','',true );
    $captcha_secret_key = themify_get( 'setting-recaptcha_secret_key','',true );
}
?>
<!-- module optin -->
	...
	<?php if ($instance ):?>
	    ...
	    >
            ...
            <?php if (!empty($captcha_site_key) && !empty($captcha_secret_key) ) : ?>
                <?php $recaptcha_version=themify_get( 'setting-recaptcha_version','v2',true ); ?>
