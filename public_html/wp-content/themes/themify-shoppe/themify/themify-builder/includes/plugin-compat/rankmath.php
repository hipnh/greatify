...
class Themify_Builder_Plugin_Compat_RankMath {
	...
	public static function admin_enqueue_scripts( $hook ) {
		...
		if (
			...
			wp_enqueue_script( 'themify-builder-rankmath', themify_enque( THEMIFY_BUILDER_URI .'/includes/plugin-compat/js/rankmath.js' ), array( 'jquery', 'wp-hooks', 'rank-math-analyzer' ), THEMIFY_VERSION, true );
		}
	}
