...
if (!class_exists('Themify_Builder')) :
	...
	private static function theme_compatibility() {
		$theme_compatibility_stylesheet = THEMIFY_BUILDER_DIR . '/theme-compat/' . get_template() . '.css';
		if ( is_file( $theme_compatibility_stylesheet ) ) {
			add_theme_support( 'themify-page-options' );
		}
		$theme_compatibility_file = THEMIFY_BUILDER_DIR . '/theme-compat/' . get_template() . '.php';
