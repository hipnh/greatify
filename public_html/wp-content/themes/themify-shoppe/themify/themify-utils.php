...
function themify_get_asset_version($fname,$include_dir='',$ver=THEMIFY_VERSION){//will be need later
 ...
 * @since 5.5.3
 */
function themify_get_template( $slug, $name = null, $args = array() ) {
...
function themify_post_filter_class( $classes, $class, $post_id ) {
	...
	if(true===$is_ajax){
		if(isset($_POST['action']) && $_POST['action']==='themify_ajax_load_more' && isset($_POST['tax'])){
