...
class Themify_Hooks {
	...
	private static $pre = 'setting-hooks';
	private static $data;
	...
	public static function hook_locations_view_setup() {
		if ( isset( $_GET['tp'] ) && $_GET['tp'] == 1 ) {
			...
			wp_enqueue_script('hook-locations-urlfix', THEMIFY_URI . '/js/admin/hook-locations-urlfix.min.js', array( 'jquery' ), THEMIFY_VERSION, true);
